...
> This step is not a hard requirement for the rest of this task, but because we launch the entire ApplicationContext in our BaseTest there'll be a lot of errors when eureka is not running. This is not a real issue, but will clutter the logs.
...
Cloud Contracts is in no way a replacement of good team to team communications or the project's own unit tests.
